...
void register_dev_compositions(CompositionRegistry& registry) {
    ...
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "CameraTruthTest"}, [](const CompositionProps&) { return test::make_camera_truth_test(); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "CameraTruthOrbit"}, [](const CompositionProps&) { return test::make_camera_truth_orbit(); }));
    ...
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "AE_CAM_01_static_grid"}, [](const CompositionProps&) { return chronon3d::content::ae_parity::ae_cam_scenes::make_ae_cam_01_static_grid(); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "AE_CAM_02_zoom_fov"}, [](const CompositionProps&) { return chronon3d::content::ae_parity::ae_cam_scenes::make_ae_cam_02_zoom_fov(); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "AE_CAM_03_two_node_poi"}, [](const CompositionProps&) { return chronon3d::content::ae_parity::ae_cam_scenes::make_ae_cam_03_two_node_poi(); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "AE_CAM_04_parent_null"}, [](const CompositionProps&) { return chronon3d::content::ae_parity::ae_cam_scenes::make_ae_cam_04_parent_null(); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "AE_CAM_05_orbit"}, [](const CompositionProps&) { return chronon3d::content::ae_parity::ae_cam_scenes::make_ae_cam_05_orbit(); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "AE_CAM_06_dolly_zoom"}, [](const CompositionProps&) { return chronon3d::content::ae_parity::ae_cam_scenes::make_ae_cam_06_dolly_zoom(); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "AE_CAM_07_gatefit"}, [](const CompositionProps&) { return chronon3d::content::ae_parity::ae_cam_scenes::make_ae_cam_07_gatefit(); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "AE_CAM_08_dof"}, [](const CompositionProps&) { return chronon3d::content::ae_parity::ae_cam_scenes::make_ae_cam_08_dof(); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "AE_CAM_09_motion_blur"}, [](const CompositionProps&) { return chronon3d::content::ae_parity::ae_cam_scenes::make_ae_cam_09_motion_blur(); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "AE_CAM_10_near_clip"}, [](const CompositionProps&) { return chronon3d::content::ae_parity::ae_cam_scenes::make_ae_cam_10_near_clip(); }));
    ...
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "ae_08_glow_pulse"}, [](const CompositionProps& p) { return test::make_ae_08_glow_pulse(p); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "ae_10_scale_pop"}, [](const CompositionProps& p) { return test::make_ae_10_scale_pop(p); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "ae_12_random_character_jitter"}, [](const CompositionProps& p) { return test::make_ae_12_random_character_jitter(p); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "ae_14_multiline_landscape"}, [](const CompositionProps& p) { return test::make_ae_14_multiline_landscape(p); }));
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "motion_blur_text"}, [](const CompositionProps& p) { return test::make_motion_blur_text(p); }));
    ...
    registry.add(make_composition_descriptor(CompositionDescriptor{
        .id = "AECameraTextParity"}, [](const CompositionProps&) {
