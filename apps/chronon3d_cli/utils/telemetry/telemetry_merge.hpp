...
inline void add_counters(chronon3d::RenderCounters& dst, const chronon3d::RenderCounters& src) {
    ...
    dst.graph_resolve_layers_wall_ms.fetch_add(src.graph_resolve_layers_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.graph_dirty_rect_wall_ms.fetch_add(src.graph_dirty_rect_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.graph_build_wall_ms.fetch_add(src.graph_build_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.graph_execute_wall_ms.fetch_add(src.graph_execute_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.graph_total_wall_ms.fetch_add(src.graph_total_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.compiled_graph_refresh_wall_ms.fetch_add(src.compiled_graph_refresh_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.cache_eval_wall_ms.fetch_add(src.cache_eval_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.dirty_eval_wall_ms.fetch_add(src.dirty_eval_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.input_resolve_wall_ms.fetch_add(src.input_resolve_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.framebuffer_lifetime_wall_ms.fetch_add(src.framebuffer_lifetime_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.node_schedule_wall_ms.fetch_add(src.node_schedule_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.node_dispatch_wall_ms.fetch_add(src.node_dispatch_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.telemetry_emit_wall_ms.fetch_add(src.telemetry_emit_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    ...
    dst.framebuffer_acquire_wall_ms.fetch_add(src.framebuffer_acquire_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.framebuffer_clear_wall_ms.fetch_add(src.framebuffer_clear_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.clearnode_wall_ms.fetch_add(src.clearnode_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.clearnode_restore_wall_ms.fetch_add(src.clearnode_restore_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    ...
    dst.framebuffer_pool_clear_wall_ms.fetch_add(src.framebuffer_pool_clear_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.framebuffer_enqueue_wall_ms.fetch_add(src.framebuffer_enqueue_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    ...
    dst.frame_conversion_copy_wall_ms.fetch_add(src.frame_conversion_copy_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.video_graph_eval_wall_ms.fetch_add(src.video_graph_eval_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.video_conversion_wall_ms.fetch_add(src.video_conversion_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.video_pipe_write_wall_ms.fetch_add(src.video_pipe_write_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.video_ffmpeg_wait_ms.fetch_add(src.video_ffmpeg_wait_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    dst.io_queue_push_wait_ms.fetch_add(src.io_queue_push_wait_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    ...
    dst.ffmpeg_pipe_write_wall_ms.fetch_add(src.ffmpeg_pipe_write_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
    ...
    dst.ffmpeg_flush_wall_ms.fetch_add(src.ffmpeg_flush_wall_ms.load(std::memory_order_relaxed), std::memory_order_relaxed);
