...
inline std::vector<chronon3d::telemetry::CounterTelemetryRecord> capture_counters(const chronon3d::RenderCounters& counters) {
    std::vector<chronon3d::telemetry::CounterTelemetryRecord> result = {
        ...
        {"effect_focus_in_ladder_ms", counters.effect_focus_in_ladder_ms.load(std::memory_order_relaxed)},
        {"effect_focus_in_ladder_precompute_ms", counters.effect_focus_in_ladder_precompute_ms.load(std::memory_order_relaxed)},
        {"effect_focus_in_ladder_crossfade_ms", counters.effect_focus_in_ladder_crossfade_ms.load(std::memory_order_relaxed)},
        {"effect_focus_in_ladder_warmup_ms", counters.effect_focus_in_ladder_warmup_ms.load(std::memory_order_relaxed)},
