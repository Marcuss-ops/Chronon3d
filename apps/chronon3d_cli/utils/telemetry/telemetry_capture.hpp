...
inline std::vector<chronon3d::telemetry::CounterTelemetryRecord> capture_counters(const chronon3d::RenderCounters& counters) {
    std::vector<chronon3d::telemetry::CounterTelemetryRecord> result = {
        ...
        {"gpu_asset_cache_initial_uploads", counters.gpu_asset_cache_initial_uploads.load(std::memory_order_relaxed)},
        {"gpu_asset_cache_initial_upload_bytes", counters.gpu_asset_cache_initial_upload_bytes.load(std::memory_order_relaxed)},
        {"gpu_asset_cache_evictions", counters.gpu_asset_cache_evictions.load(std::memory_order_relaxed)},
        {"gpu_asset_cache_evicted_bytes", counters.gpu_asset_cache_evicted_bytes.load(std::memory_order_relaxed)},
        {"gpu_asset_cache_resident_bytes", counters.gpu_asset_cache_resident_bytes.load(std::memory_order_relaxed)},
        ...
        {"gpu_text_glyphs_built", counters.gpu_text_glyphs_built.load(std::memory_order_relaxed)},
        {"gpu_text_fast_path_success", counters.gpu_text_fast_path_success.load(std::memory_order_relaxed)},
        {"gpu_text_fallback_count", counters.gpu_text_fallback_count.load(std::memory_order_relaxed)},
        ...
        {"frame_slot_wait_count", counters.frame_slot_wait_count.load(std::memory_order_relaxed)},
        {"frame_slot_wait_us", counters.frame_slot_wait_us.load(std::memory_order_relaxed)},
        ...
        {"native_surface_yuv_frames", counters.native_surface_yuv_frames.load(std::memory_order_relaxed)},
        ...
        {"video_decode_native_surface_frames", counters.video_decode_native_surface_frames.load(std::memory_order_relaxed)},
        {"video_decode_hw_transfer_frames", counters.video_decode_hw_transfer_frames.load(std::memory_order_relaxed)},
        {"video_decode_software_frames", counters.video_decode_software_frames.load(std::memory_order_relaxed)},
        {"video_decode_native_fallback_frames", counters.video_decode_native_fallback_frames.load(std::memory_order_relaxed)},
        ...
        {"native_surface_promotion_count", counters.native_surface_promotion_count.load(std::memory_order_relaxed)},
        {"native_surface_promotion_bytes", counters.native_surface_promotion_bytes.load(std::memory_order_relaxed)},
        {"native_surface_promotion_wall_us", counters.native_surface_promotion_wall_us.load(std::memory_order_relaxed)},
        {"native_surface_empty_create_count", counters.native_surface_empty_create_count.load(std::memory_order_relaxed)},
        {"native_surface_reuse_count", counters.native_surface_reuse_count.load(std::memory_order_relaxed)},
        {"hwframe_transfer_to_cpu_frames", counters.hwframe_transfer_to_cpu_frames.load(std::memory_order_relaxed)},
        {"software_color_convert_frames", counters.software_color_convert_frames.load(std::memory_order_relaxed)},
        {"cpu_full_surface_upload_bytes", counters.cpu_full_surface_upload_bytes.load(std::memory_order_relaxed)},
        {"gpu_readback_bytes", counters.gpu_readback_bytes.load(std::memory_order_relaxed)},
        {"nvenc_frames", counters.nvenc_frames.load(std::memory_order_relaxed)},
        {"software_encode_frames", counters.software_encode_frames.load(std::memory_order_relaxed)},
        {"decode_submit_ms", counters.decode_submit_ms.load(std::memory_order_relaxed)},
        {"decode_wait_ms", counters.decode_wait_ms.load(std::memory_order_relaxed)},
        {"hwframe_transfer_ms", counters.hwframe_transfer_ms.load(std::memory_order_relaxed)},
        {"swscale_ms", counters.swscale_ms.load(std::memory_order_relaxed)},
        {"cpu_pixel_conversion_ms", counters.cpu_pixel_conversion_ms.load(std::memory_order_relaxed)},
        {"full_surface_upload_ms", counters.full_surface_upload_ms.load(std::memory_order_relaxed)},
        {"video_composite_ms", counters.video_composite_ms.load(std::memory_order_relaxed)},
        {"encode_submit_ms", counters.encode_submit_ms.load(std::memory_order_relaxed)},
        {"encode_wait_ms", counters.encode_wait_ms.load(std::memory_order_relaxed)},
        ...
        {"tile_dirty_count", counters.tile_dirty_count.load(std::memory_order_relaxed)},
        {"tile_clean_count", counters.tile_clean_count.load(std::memory_order_relaxed)},
        {"tile_pixels_rendered", counters.tile_pixels_rendered.load(std::memory_order_relaxed)},
        {"tile_pixels_skipped", counters.tile_pixels_skipped.load(std::memory_order_relaxed)},
        {"tile_full_fallbacks", counters.tile_full_fallbacks.load(std::memory_order_relaxed)},
        {"tile_regions_executed", counters.tile_regions_executed.load(std::memory_order_relaxed)},
        {"tile_region_pixels", counters.tile_region_pixels.load(std::memory_order_relaxed)},
        {"tile_execution_wall_ms", counters.tile_execution_wall_ms.load(std::memory_order_relaxed)},
        {"full_frame_passes", counters.full_frame_passes.load(std::memory_order_relaxed)},
        {"full_frame_copies", counters.full_frame_copies.load(std::memory_order_relaxed)},
