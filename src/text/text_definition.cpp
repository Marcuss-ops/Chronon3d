...
TextDefinition from_text_spec(const TextSpec& spec) {
    ...
    // ── frame ──────────────────────────────────────────────────────────
    // Phase A4 close-out: TextFrame placement field (gate #20) replaces the    // Vec3 position + TextPlacementKind + Vec2 offset triple. Forward and         // reverse adapters collapse to a one-line copy of the canonical struct.   
