...
//       (1) `chronon3d::detail::utf8_decode`         in include/chronon3d/text/text_unicode_utils.hpp  // drift-class: historical (header removed)
//       (2) `chronon3d::detail::decode_utf8_codepoint_from` in include/chronon3d/text/glyph_selector.hpp
//       (3) `composer_internal::decode_codepoint_at` in src/text/boundary_resolver/composer_helpers.hpp
//       (4) anonymous `decode_utf8(sv, idx)` in src/text/boundary_resolver/text_unit_map.cpp
