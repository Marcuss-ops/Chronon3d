...
#include <chronon3d/scene/builders/builder_params.hpp>  // P1 — TextRunDefinition (TextRunDefinition alias) for the migrated shape_ids::TextRun call site.
...
void draw_content(LayerBuilder& l, const MotionObject& obj, const MotionState& st, const std::string& layer_name) {
    ...
    case MotionObjectType::Text: {
        ...
        // direct caller now wraps the TextDefaults into a TextRunDefinition (alias
        // TextRunDefinition) and reaches the render graph via shape_ids::TextRun
        ...
        chronon3d::TextRunDefinition run_params;
        run_params.text = chronon3d::TextDefaults{
