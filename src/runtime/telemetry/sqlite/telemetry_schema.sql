CREATE TABLE IF NOT EXISTS render_runs (
    ...
    process_context_switches_voluntary INTEGER DEFAULT 0,
    process_context_switches_involuntary INTEGER DEFAULT 0,
    os_page_faults_major INTEGER DEFAULT 0,
    os_page_faults_minor INTEGER DEFAULT 0,
    ffmpeg_cpu_user_pct INTEGER DEFAULT 0,
    ffmpeg_cpu_sys_pct INTEGER DEFAULT 0,
    llc_references INTEGER DEFAULT 0,
    llc_misses INTEGER DEFAULT 0,
