CREATE TABLE IF NOT EXISTS render_runs (
    ...
    framebuffer_acquire_wall_ms INTEGER DEFAULT 0,
    framebuffer_clear_wall_ms INTEGER DEFAULT 0,
    clearnode_wall_ms INTEGER DEFAULT 0,
    clearnode_restore_wall_ms INTEGER DEFAULT 0,
    ...
    framebuffer_pool_clear_wall_ms INTEGER DEFAULT 0,
    framebuffer_enqueue_wall_ms INTEGER DEFAULT 0,
    ...
    frame_conversion_copy_wall_ms INTEGER DEFAULT 0,
    video_graph_eval_wall_ms INTEGER DEFAULT 0,
    video_conversion_wall_ms INTEGER DEFAULT 0,
    video_pipe_write_wall_ms INTEGER DEFAULT 0,
    video_ffmpeg_wait_ms INTEGER DEFAULT 0,
    io_queue_push_wait_ms INTEGER DEFAULT 0,
    io_queue_pop_wait_ms INTEGER DEFAULT 0,
    io_writer_idle_wait_ms INTEGER DEFAULT 0,
    io_queue_peak_depth INTEGER DEFAULT 0,
    ffmpeg_pipe_write_wall_ms INTEGER DEFAULT 0,
    converted_frame_cache_hits INTEGER DEFAULT 0,
    ffmpeg_flush_wall_ms INTEGER DEFAULT 0,
    io_queue_peak_bytes INTEGER DEFAULT 0,
    setup_graph_parsing_wall_ms INTEGER DEFAULT 0,
    setup_asset_io_load_wall_ms INTEGER DEFAULT 0,
    setup_pool_preallocation_wall_ms INTEGER DEFAULT 0,
    image_decode_wall_ms INTEGER DEFAULT 0,
    compiled_graph_refresh_wall_ms INTEGER DEFAULT 0,
    cache_eval_wall_ms INTEGER DEFAULT 0,
    dirty_eval_wall_ms INTEGER DEFAULT 0,
    input_resolve_wall_ms INTEGER DEFAULT 0,
    predicted_bbox_wall_ms INTEGER DEFAULT 0,
    clone_context_wall_ms INTEGER DEFAULT 0,
    state_assign_wall_ms INTEGER DEFAULT 0,
    framebuffer_lifetime_wall_ms INTEGER DEFAULT 0,
    node_schedule_wall_ms INTEGER DEFAULT 0,
    node_dispatch_wall_ms INTEGER DEFAULT 0,
    node_execute_actual_wall_ms INTEGER DEFAULT 0,
    node_overhead_wall_ms INTEGER DEFAULT 0,
    telemetry_emit_wall_ms INTEGER DEFAULT 0,
