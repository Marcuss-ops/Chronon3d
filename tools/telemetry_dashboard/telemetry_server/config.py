...
RUN_COLUMNS = [
    ...
    'framebuffer_acquire_ms', 'framebuffer_clear_ms', 'clearnode_ms', 'clearnode_restore_ms',
    ...
    'setup_pool_preallocation_ms', 'image_decode_ms', 'image_sample_ms', 'image_sampled_pixels',
    ...
    'node_execute_actual_ms', 'node_overhead_ms',
