...
RUN_COLUMNS = [
    ...
    'framebuffer_acquire_wall_ms', 'framebuffer_clear_wall_ms', 'clearnode_wall_ms', 'clearnode_restore_wall_ms',
    'framebuffer_pool_clear_wall_ms', 'framebuffer_enqueue_wall_ms',
    'framebuffer_pool_empty_alloc', 'framebuffer_pool_miss_count_empty',
    'framebuffer_pool_miss_count_best_fit', 'framebuffer_pool_miss_count_size_mismatch',
    'framebuffer_pool_best_fit_reuse', 'framebuffer_pool_exact_hit', 'framebuffer_pool_hits',
    ...
    'setup_pool_preallocation_wall_ms', 'image_decode_wall_ms', 'image_sample_ms', 'image_sampled_pixels',
    'compiled_graph_refresh_wall_ms', 'cache_eval_wall_ms', 'dirty_eval_wall_ms', 'input_resolve_wall_ms',
    'framebuffer_lifetime_wall_ms', 'node_schedule_wall_ms', 'node_dispatch_wall_ms', 'telemetry_emit_wall_ms',
    'predicted_bbox_wall_ms', 'clone_context_wall_ms', 'state_assign_wall_ms',
    'node_execute_actual_wall_ms', 'node_overhead_wall_ms',
