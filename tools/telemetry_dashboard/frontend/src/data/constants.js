...
export const INFO_DESCRIPTIONS = {
  ...
  framebuffer_allocations: 'Total framebuffer allocations performed during the run.',
  framebuffer_reuses: 'Total framebuffer pool reuses during the run.',
  framebuffer_bytes_peak: 'Peak bytes held by framebuffer memory pools.',
