...
# Combines the previous top-level CHRONON3D_BUILD_TESTS guard + the
# inner `CHRONON3D_BUILD_BENCHMARKS AND TARGET benchmark::benchmark_main`
# body-wrap into a single early-return so the gate is named once.
if(NOT CHRONON3D_BUILD_TESTS
   OR NOT CHRONON3D_BUILD_BENCHMARKS
   OR NOT TARGET benchmark::benchmark_main)
    return()
endif()
