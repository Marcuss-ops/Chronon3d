...
TEST_CASE("TextRunNode: draw_text_run ExecutionFailure surfaces diagnostic (P0-3 audit #2)") {
    ...
    TextRunNode node("P03_execfail_node", "text_layer", shape, render_ref, key, TextRunPlacement{});
...
TEST_CASE("TextRunNode: absent text_run capability is diagnosed once per node (P0-3)") {
    ...
    RenderNode render_ref{};
    cache::NodeCacheKey key{};
    TextRunNode node("P03_no_capability_node", "text_layer", shape, render_ref, key, TextRunPlacement{});
...
TEST_CASE("TextRunNode: null backend is diagnosed once per node (P0-3)") {
    ...
    RenderNode render_ref{};
    cache::NodeCacheKey key{};
    TextRunNode node("P03_null_backend_node", "text_layer", shape, render_ref, key, TextRunPlacement{});
