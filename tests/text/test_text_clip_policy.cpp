...
// ══════════════════════════════════════════════════════════════════════════
// §4A-ext false-green audit: deliberately oversized text inside a small
// clip box.  Verifies that the rendered ink is contained by the box and
// that the clip policy is not a no-op.
// ═══════════════════════════════════════════════════════════════════════════
...
TEST_CASE("TICKET-FALSE-GREEN-TEST-AUDIT: clip policy contains oversized text") {
    ...
    LayerBuilder lb("clip_oversized_layer", SampleTime{});
    lb.screen_dimensions(1920.0f, 1080.0f);
    lb.text("clip_oversized_text", TextSpec{
