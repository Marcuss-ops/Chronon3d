...
// (Typewriter pipeline tests removed — compositions deleted for fresh start)
...
// (Motion-object / typewriter pipeline regression tests removed — compositions deleted for fresh start)
