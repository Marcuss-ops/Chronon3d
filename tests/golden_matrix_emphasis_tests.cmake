# ═══════════════════════════════════════════════════════════════════════════
# tests/golden_matrix_emphasis_tests.cmake — TICKET-GOLDEN-MATRIX-BATCH-3
#
# Golden matrix sweep harness for the 4 baseline Emphasis-category presets
# (word_pop, scale_punch, color_accent, gradient_fill).  Per-cell golden
# PNG emission + 11-metric ScenarioMetrics capture via the shared
...
#
# Update goldens: CHRONON3D_UPDATE_GOLDENS=1 ctest -R chronon3d_golden_matrix_emphasis_tests
# ═══════════════════════════════════════════════════════════════════════════
...
chronon3d_add_test_suite(
    NAME chronon3d_golden_matrix_emphasis_tests
    TIER INTEGRATION
    ...
    LINK_TARGETS chronon3d_sdk chronon3d_software chronon3d_pipeline
                  ...
                  chronon3d_text_core
    SOURCES ${CMAKE_CURRENT_SOURCE_DIR}/text_golden/matrix/test_golden_matrix_emphasis.cpp
            ${CMAKE_CURRENT_SOURCE_DIR}/visual/support/golden_test.cpp
            ${CMAKE_CURRENT_SOURCE_DIR}/visual/support/image_diff.cpp
)
target_compile_definitions(chronon3d_golden_matrix_emphasis_tests PRIVATE
