...
// `SoftwareRenderer&`), add a tests/backends_software_tests.cmake (or wire  // drift-allow: stale-ref
// this single TU into tests/backends_software_tests.cmake) and  // drift-allow: stale-ref
