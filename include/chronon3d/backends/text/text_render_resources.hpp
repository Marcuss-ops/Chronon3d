...
namespace detail {
    struct TextRasterCache;  // P1-8: forward decl; full def in text_render_resources.cpp
    class GlyphAtlasCache;   // P1-9: forward decl; full def in text/glyph_atlas.hpp
}
