...
/// Convenience overload for standalone cache construction.  It snapshots the
/// environment into a local Config value; no process-wide configuration is
/// retained. Runtime-owned caches should prefer the explicit overload above.
[[nodiscard]] CachePolicy resolve_cache_policy(
    CacheDomain                    domain,
