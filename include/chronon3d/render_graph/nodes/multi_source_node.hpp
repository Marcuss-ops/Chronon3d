...
public:
    ...
    // projection is now conditioned on ctx.frame_input.has_camera_2_5d
    // globally (Soluzione B).  can_seed_full_frame() (which always returns
    // false for MultiSourceNode) handles the runtime check.
