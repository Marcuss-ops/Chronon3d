...
// =============================================================================
// include/chronon3d/video/null_encoders.hpp — Benchmark/sink encoders
//
// Part of chronon3d_backend_video.  Implements IVideoEncoder for benchmark
// and testing purposes:
//   - NullRenderEncoder:  count frames, no conversion or I/O
//   - NullConvertEncoder: convert pixels, no I/O
//   - RawVideoSinkEncoder: convert + write raw bytes to file
// =============================================================================
...
public:
    ...
    void set_counters(chronon3d::RenderCounters* counters) override { counters_ = counters; }
    [[nodiscard]] uint64_t frames_written() const override { return frames_written_; }
