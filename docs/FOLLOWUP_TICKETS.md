...
| Perf baseline v1 + SW composite blur SEGV | P1 | DONE/OPEN | [PERF-BASELINE-V1](tickets/TICKET-PERF-BASELINE-V1.md) — baseline lockata; fix blur-in-composite necessario per riabilitare BENCH-3 blur |
