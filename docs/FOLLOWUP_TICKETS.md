...
| CLI V3 unification | P1 | OPEN | `TICKET-ADD-LOADER-FOR-CHRONON-JSON` + `TICKET-V3-CLI-UNIFICATION-ALIASES-PHASE-3` + `TICKET-V3-CLI-UNIFICATION-STARTER-TEMPLATE` + `TICKET-WATCH-PROPS-FILE` + `TICKET-PREVIEW-CONTACT-SHEET` + `TICKET-PREVIEW-CELL-LABELS`: loader `chronon.json`, alias `still`/`video`, starter template, watch/preview CLI. | [loader](tickets/TICKET-ADD-LOADER-FOR-CHRONON-JSON.md) · [aliases](tickets/TICKET-V3-CLI-UNIFICATION-ALIASES-PHASE-3.md) · [template](tickets/TICKET-V3-CLI-UNIFICATION-STARTER-TEMPLATE.md) · [watch](tickets/TICKET-WATCH-PROPS-FILE.md) · [preview](tickets/TICKET-PREVIEW-CONTACT-SHEET.md) · [labels](tickets/TICKET-PREVIEW-CELL-LABELS.md) |
...
| Executor / cache rot | P2 | OPEN | `TICKET-NODE-CACHE-KEY-COLLAPSE-ROT` + `TICKET-V3-LEGACY-EXEC-CLOSURE`: NodeCacheKey build rot e chiusura legacy executor. | [node-cache](tickets/TICKET-NODE-CACHE-KEY-COLLAPSE-ROT.md) · [exec-closure](tickets/TICKET-V3-LEGACY-EXEC-CLOSURE.md) |
