...
* `include/chronon3d/timeline/timeline_sample_context.hpp` (NEW header per `chronon3d::TimelineSampleContext` POD, target post-Addendum Step 4 promotion).
