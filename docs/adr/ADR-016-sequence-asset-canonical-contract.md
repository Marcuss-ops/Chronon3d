...
| Symbol | Type | Role |
|---|---|---|
| `AssetKind` | `enum class : unsigned char { Font, Image, Video, Audio, Mesh }` | Discriminator 5 valori (1 byte). Distinto da `chronon3d::AssetType` esistente in `asset_metadata.hpp` (5 valori inclusi Mesh + Unknown, semantica metadata/registry); `Mesh` identifica qui una dependency logica, mentre import/preparation GLB resta una fase successiva. I valori non sono allineati per prevenire `static_cast` cross-enum accidentale. |
