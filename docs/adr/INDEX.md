...
| ADR-029 | Chronon VisualPresetRegistry: single source of truth for overlay-level visual presets (`VisualPresetDescriptor { id, version, supported_layer, base_preset, style, anchor, animation, fallback_anchors, capabilities }`); PipelineGen keeps only SemanticOverlayResolver, RenderingGen stays a dumb worker; eliminates the duplicated Go preset registries. | Proposed (2026-08-17) | [visual-preset-registry](ADR-029-visual-preset-registry.md) |
