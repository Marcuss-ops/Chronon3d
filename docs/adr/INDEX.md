...
| ADR-029 | Project semantic content registry: one generic instance-owned deterministic registry for phrases, important words, logical images, and named text; focused SDK header, no global singleton/resolver | ✅ Accepted (2026-08-14) | [project-semantic-content-registry](ADR-029-project-semantic-content-registry.md) |
