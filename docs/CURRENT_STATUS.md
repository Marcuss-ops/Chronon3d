...
| Text Production / CapCut-grade V1 | PARTIAL | Text Export V1 certified; 5/20 general presets, 0/8 subtitle presets, no tracked golden PNGs, no SRT/word-timing, per-word highlight not wired; vedi [TICKET-TEXT-PRODUCTION-STATUS-CORRECTION](tickets/TICKET-TEXT-PRODUCTION-STATUS-CORRECTION.md). |
