...
- documenti canonici: `docs/ARCHIVE/STATUS.md`, `docs/ARCHIVE/NEXT_STEPS.md`, `docs/ROADMAP.md`, `docs/ARCHIVE/stabilization-plan/README.md` e piani direttamente interessati
...
- `ARCHIVE/STATUS.md`, `ARCHIVE/NEXT_STEPS.md`, `ROADMAP.md` e stabilization plan descrivono lo stesso stato;
