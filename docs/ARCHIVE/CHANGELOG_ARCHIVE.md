# Chronon3D — Changelog Archive (pre-July 10, 2026)

> **NOTA:** Questo file contiene le entry storiche del changelog
> precedenti al 2026-07-10 (era pre-Text Simplicity).
> Per le entry recenti, vedi [`docs/CHANGELOG.md`](../CHANGELOG.md).
