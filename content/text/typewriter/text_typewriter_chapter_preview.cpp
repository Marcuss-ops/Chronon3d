...
Composition text_typewriter_chapter_preview() {
    ...
    return make_typewriter("TextTypewriterChapterPreview", {
    ...
    }, presets::motion::MotionPreset::PerspectiveSweepTextReveal, true, {0.009f, 0.012f, 0.02f, 1}, 45, 1280.0f, 1280, 720);
}
