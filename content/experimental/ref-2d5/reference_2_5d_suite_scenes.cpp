...
Composition depth_fog_test() {
    return composition({.name = "DepthFogTest", .width = kW, .height = kH, .duration = 180}, [](const FrameContext& ctx) {
        ...
        s.layer("title", [](LayerBuilder& l) { l.position({0.0f, -10.0f, 0.0f}); l.text("future", TextSpec{.content = {.value = "FUTURE"},.placement = TextPlacement{TextPlacementKind::Absolute, {0.0f, -78.0f}},.font = {.font_path = "assets/fonts/Poppins-Bold.ttf", .font_family = "Inter", .font_weight = 900, .font_size = 44.0f},
                                                                                                  .layout = {.box = {700.0f, 80.0f}, .align = TextAlign::Center, .vertical_align = VerticalAlign::Middle},.appearance = {.color = {0.26f, 0.48f, 0.80f, 0.36f}},}); l.glow(GlowParams{.radius = 40.0f, .intensity = 1.2f, .color = {0.22f, 0.72f, 1.0f, 1.0f}}); l.text("innovate", TextSpec{.content = {.value = "INNOVATE"},.placement = TextPlacement{TextPlacementKind::Absolute, {0.0f, -8.0f}},.font = {.font_path = "assets/fonts/Poppins-Bold.ttf", .font_family = "Inter", .font_weight = 900, .font_size = 56.0f},
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       .layout = {.box = {780.0f, 96.0f}, .align = TextAlign::Center, .vertical_align = VerticalAlign::Middle},.appearance = {.color = {0.40f, 0.64f, 0.92f, 0.52f}},}); l.text("build", TextSpec{.content = {.value = "BUILD"},.placement = TextPlacement{TextPlacementKind::Absolute, {0.0f, 104.0f}},.font = {.font_path = "assets/fonts/Poppins-Bold.ttf", .font_family = "Inter", .font_weight = 900, .font_size = 94.0f},
