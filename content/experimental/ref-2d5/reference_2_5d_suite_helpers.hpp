...
inline void add_header(SceneBuilder& s, const std::string& id, const std::string& title, const std::string& subtitle) {
    ...
    s.layer("header_" + id, [=](LayerBuilder& l) {
        ...
        l.text("badge_txt", TextSpec{.content = {.value = id},.position = {0.0f, 0.0f, 0.0f},.font = {.font_path = "assets/fonts/Poppins-Bold.ttf", .font_family = "Inter", .font_weight = 900, .font_style = "normal", .font_size = 24.0f},.layout = {.box = {52.0f, 52.0f}, .align = TextAlign::Center, .vertical_align = VerticalAlign::Middle},.appearance = {.color = kWhite},});
        l.text("title", TextSpec{.content = {.value = title},.position = {84.0f, 0.0f, 0.0f},.font = {.font_path = "assets/fonts/Poppins-Bold.ttf", .font_family = "Inter", .font_weight = 900, .font_style = "normal", .font_size = title_font_size},.layout = {.box = {1060.0f, 36.0f}, .align = TextAlign::Left, .vertical_align = VerticalAlign::Middle},.appearance = {.color = kWhite},});
        l.text("subtitle", TextSpec{.content = {.value = subtitle},.position = {84.0f, 0.0f, 0.0f},.font = {.font_path = "assets/fonts/Poppins-Regular.ttf", .font_family = "Inter", .font_weight = 400, .font_style = "normal", .font_size = subtitle_font_size},.layout = {.box = {1060.0f, 24.0f}, .align = TextAlign::Left, .vertical_align = VerticalAlign::Middle},.appearance = {.color = {0.78f, 0.82f, 0.92f, 1.0f}},});
    });
}
