        ...
        [](const FrameContext& ctx) -> Scene {
            ...
            s.layer("long_text", [kBoxW, kBoxH](LayerBuilder& l) {
                l.text("body", from_text_spec(TextSpec{.content = {.value = "This is a very long sentence that must wrap "
                                            ...
                                            "hyphenated mid-character."}, .placement = {TextPlacementKind::Absolute, {static_cast<float>(kWidth) * 0.5f, kMargin + kBoxH * 0.5f}}, .font = {.font_path   = "assets/fonts/Inter-Bold.ttf",
                                   .font_family = "Inter",
                                   .font_weight = 400,
