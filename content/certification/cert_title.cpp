...
void register_cert_title_compositions(CompositionRegistry& registry) {
    registry.add(certification_descriptor(
        "CertTitle", 1920, 1080, Frame{1},
        [](const CompositionProps&) { return cert_title(); }));
    registry.add(certification_descriptor(
        "CertTitleVertical", 1080, 1920, Frame{1},
        [](const CompositionProps&) { return cert_title_vertical(); }));
}
