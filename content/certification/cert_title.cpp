    ...
    return composition(
        ...
        [text, font_size, width, height](const FrameContext& ctx) -> Scene {
            ...
            s.layer("title", [&](LayerBuilder& l) {
                ...
                l.text("title_text", from_text_spec(TextSpec{.content = {.value = text}, .placement = {TextPlacementKind::Absolute, {static_cast<float>(width) * 0.5f, static_cast<float>(height) * 0.5f}}, .font = {.font_path   = "assets/fonts/Inter-Bold.ttf",
                                   .font_family = "Inter",
                                   .font_weight = 700,
